        ...
        public async Task<IActionResult> GetExcelData(UploadedRecordsRequestAPI request)
        {
            ...
            switch (request.FileTypeCode)
            {
                case (int)ExcelFileType.BranchMaster:
                    request2 = new GetExcelDataQuery<BranchMaster>() { FileTypeCode = request.FileTypeCode, BatchId = request.BatchId, PageNumber = request.PageNumber, NumberOfRecords = request.NumberOfRecords, SortDirection = request.SortDirection, SortColumn = request.SortColumn, Search = request.Search };
                ...
                case (int)ExcelFileType.DepartmentMaster:
                    request2 = new GetExcelDataQuery<DepartmentMaster>() { FileTypeCode = request.FileTypeCode, BatchId = request.BatchId, PageNumber = request.PageNumber, NumberOfRecords = request.NumberOfRecords, SortDirection = request.SortDirection, SortColumn = request.SortColumn, Search = request.Search };
                    result = await _mediator.Send(request2);
                ...
                case (int)ExcelFileType.EmployeeMaster:
                    request2 = new GetExcelDataQuery<EmployeeMaster>() { FileTypeCode = request.FileTypeCode, BatchId = request.BatchId, PageNumber = request.PageNumber, NumberOfRecords = request.NumberOfRecords, SortDirection = request.SortDirection, SortColumn = request.SortColumn, Search = request.Search };
                    result = await _mediator.Send(request2);                    
                ...
                case (int)ExcelFileType.InterRegionPromotion:
                    request2 = new GetExcelDataQuery<InterRegionalPromotion>() { FileTypeCode = request.FileTypeCode, BatchId = request.BatchId, PageNumber = request.PageNumber, NumberOfRecords = request.NumberOfRecords, SortDirection = request.SortDirection, SortColumn = request.SortColumn, Search = request.Search };
                    result = await _mediator.Send(request2);
                ...
                case (int)ExcelFileType.InterRegionRequestTransfer:
                    request2 = new GetExcelDataQuery<InterRegionRequestTransfer>() { FileTypeCode = request.FileTypeCode, BatchId = request.BatchId, PageNumber = request.PageNumber, NumberOfRecords = request.NumberOfRecords, SortDirection = request.SortDirection, SortColumn = request.SortColumn, Search = request.Search };
                    result = await _mediator.Send(request2);
                ...
                case (int)ExcelFileType.InterZonalPromotion:
                    request2 = new GetExcelDataQuery<InterZonalPromotion>() { FileTypeCode = request.FileTypeCode, BatchId = request.BatchId, PageNumber = request.PageNumber, NumberOfRecords = request.NumberOfRecords, SortDirection = request.SortDirection, SortColumn = request.SortColumn, Search = request.Search };
                    result = await _mediator.Send(request2);
                ...
                case (int)ExcelFileType.InterZonalRequestTranfer:
                    request2 = new GetExcelDataQuery<InterZonalRequestTransfer>() { FileTypeCode = request.FileTypeCode, BatchId = request.BatchId, PageNumber = request.PageNumber, NumberOfRecords = request.NumberOfRecords, SortDirection = request.SortDirection, SortColumn = request.SortColumn, Search = request.Search };
                    result = await _mediator.Send(request2);
                ...
                case (int)ExcelFileType.RegionMaster:
                    request2 = new GetExcelDataQuery<RegionMaster>() { FileTypeCode = request.FileTypeCode, BatchId = request.BatchId, PageNumber = request.PageNumber, NumberOfRecords = request.NumberOfRecords, SortDirection = request.SortDirection, SortColumn = request.SortColumn, Search = request.Search };
                    result = await _mediator.Send(request2);
                ...
                case (int)ExcelFileType.ZoneMaster:
                    request2 = new GetExcelDataQuery<ZoneMaster>() { FileTypeCode = request.FileTypeCode, BatchId = request.BatchId, PageNumber = request.PageNumber, NumberOfRecords = request.NumberOfRecords, SortDirection = request.SortDirection, SortColumn = request.SortColumn, Search = request.Search };
                    result = await _mediator.Send(request2);
