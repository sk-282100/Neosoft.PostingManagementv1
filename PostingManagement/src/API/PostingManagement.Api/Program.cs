...
using PostingManagement.Api.Middleware;
using PostingManagement.Application;
using PostingManagement.Application.Contracts;
using PostingManagement.Infrastructure;
using PostingManagement.Persistence;
using PostingManagement.Api.Extensions;
using Microsoft.Extensions.Options;
using Swashbuckle.AspNetCore.SwaggerGen;
using PostingManagement.Api.SwaggerHelper;
using Microsoft.AspNetCore.DataProtection;
using PostingManagement.Auth;
